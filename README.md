...
[Comunicado de Secretaría Académica](http://www.fadu.uba.ar/application/information/view/510)


Interesante comunicado que traza varias problemáticas por las cuales no se puede garantizar la "modalidad virtual" en la Facultad.


«Sabemos de la ansiedad que provocan estas incertidumbres, pero las mismas no solo involucran a los temas académicos sino, y más importante aún, a nuestras vidas y las de nuestras familias. Muchxs argentinas y argentinos la están pasando muy mal y la situación socioeconómica seguramente se agrave. Nuestro compromiso es seguir compartiendo toda la información que tengamos y a la vez, solicitarles que transmitan calma a sus estudiantes y docentes y ayuden a sus equipos a que encuentren la paciencia que la actual situación nos pide. Esto es también parte de la responsabilidad que nos toca.»

#### Problemas que marca


* Problemas de Internet en docentes y estudiantes

  «También la Universidad está en tratativas con ARSAT para actuar en ese sentido, lo que no garantiza la calidad de las redes domiciliarias que ya están presentando reducciones en el ancho de banda disponible y cortes permanentes de servicio»

* Presencialidad y su importancia en el aprendizaje

  «Otras reflexiones relevantes surgidas de esa reunión, tienen que ver con el modelo de nuestras carreras, que son presenciales, y en esa condición, deben garantizar reglamentariamente que el 70% de las clases sean presenciales.

  Desde FADU, reivindicamos nuestro valioso modelo de enseñanza-aprendizaje. Es así que consideramos que el Taller –presencial–, es dificilmente reemplazable por modelos no presenciales. Reconocemos que algunos de sus contenidos pueden ser desarrollados a distancia, pero no su tronco proyectual, al menos en las actuales condiciones.»


* Poco tiempo para preparar seriamente la modalidad virtual

  «También se discutió respecto a la seriedad y el tiempo que requieren los desarrollos de modelos a distancia, que dificilmente son los que median entre el momento actual y un eventual –y poco probable– inicio de cuatrimestre a mediados de abril, entendiendo que la consistencia de la propuesta académica debe ser uniforme y democrática para todas las cátedras y asignaturas.»

* No todos los estudiantes disponen de los medios

  «Otro tema, no menor, es la disponibilidad de los servicios de internet para nuestrxs estudiantes y docentes. Muchxs estudiantes sólo acceden desde el celular porque no disponen de computadora propia o servicios con grandes cantidades de datos disponibles en sus teléfonos y utilizan la red de la facultad para actualizar su información. Tampoco tienen servicio de internet en sus hogares y recordemos que la presente coyuntura sanitaria requiere permanecer allí. Este modelo virtual, implica necesariamente el acceso a un servicio al que no todxs lxs estudiantes o docentes pueden acceder desde sus hogares. Hemos evaluado que participar de una teleconferencia o asistir a un video asincrónico de 40’ implica un gasto de datos equivalentes a $ 200. Debemos ser muy concientes de la decisión de implementar sistemas de este tipo, al menos en el grado, en la universidad pública y gratuita. También reflexionar sobre las capacidades de autogestión diferentes, por ejemplo entre un estudiante que ingresa a cualquier carrera y otro avanzado.»
